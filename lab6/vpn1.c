...
//	const char dest1[4] = {192, 168, 0, 0};
	const char dest0[4] = {10, 0, 0, 0};
	const char dest1[4] = {172, 0, 0, 0};
...
//	const char gateway1[4] = {172, 0, 0, 1};
        const char gateway0[4] = {10, 0, 0, 2};
	const char gateway1[4] = {192, 168, 0, 1};
	...
	memcpy(route_item[0].interface, interface0, 5);
	memcpy(route_item[1].interface, interface1, 5);
...
//	const char mac0[8] = {0x0, 0x0c, 0x29, 0xb4, 0x01, 0x11};
//	const char mac1[8] = {0x0, 0x0c, 0x29, 0x45, 0x09, 0x12};
	const char dest_ip0[4] = {10, 0, 0, 2};
	const char dest_ip1[4] = {192, 168, 0, 1};
	const char mac0[8] = {0x0, 0x0c, 0x29, 0x28, 0x81, 0x99};
	const char mac1[8] = {0x0, 0x0c, 0x29, 0x6b, 0xfe, 0x4c};
...
void init_vpn_tab(){
	vpn_index = 1;
//	const char dest0[4] = {0xa, 0x0, 0x0, 0x0};
//	const char netmask0[4] = {0xff, 0xff, 0xff, 0x0};
//	const char dest_vpn0[4] = {0xc0, 0xa8, 0x0, 0x2};
	const char dest0[4] = {0xa, 0x0, 0x1, 0x0};
	const char netmask0[4] = {0xff, 0xff, 0xff, 0x0};
	const char dest_vpn0[4] = {172, 0, 0, 2};
...
int repacket(int index1, int len){
	if(index1 == 0){
		...
		ip0->ip_src.s_addr = inet_addr("192.168.0.2");
		int i;
